        ...
        <div id="sidebar-scrollbar">
          <nav className="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" className="iq-menu">
              ...
              <li className="active">
                <a href="index.html" className="iq-waves-effect"><i className="ri-home-4-line" /><span>Dashboard
                  1</span></a>
              </li>
              <li>
              ...
              <li>
                <a href="#userinfo" className="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i className="ri-user-line" /><span>User</span><i className="ri-arrow-right-s-line iq-arrow-right" /></a>
              ...
              <li>
                <a href="#ecommerce" className="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i className="ri-shopping-cart-line" /><span>E-commerce</span><i className="ri-arrow-right-s-line iq-arrow-right" /></a>
